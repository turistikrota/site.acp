...
import MarkdownEditor, { uploadMdContent } from "@/components/Kit/MarkdownContent";
        ...
        <Spin loading={loading}>
            <Form onSubmit={onSubmit}>
                ...
                <Card className="r-card">
                  <CardHeader>
                    <CardHeadContent
                      title={t("faq.form.detail.title")}
                      subtitle={t("faq.form.detail.subtitle")}
                    />
                  </CardHeader>
                  <CardBody>
                    <Row>
...
export {
    HelpArticleCreateView as Component
};
